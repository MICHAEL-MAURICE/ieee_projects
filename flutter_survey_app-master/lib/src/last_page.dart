...
class LastPageState extends State<LastPage> {
  ...
  void initState() {
    ...
    if (widget.statusType == 'Unhappy') {
      ...
      msg = 'We are so sorry. What did our organizors do wrong?';
      feedbackList = [
        Feedback('Not helpful and not thoughful', false),
        Feedback('Always busy and not responsive', false),
        Feedback('Little technical experiance', false),
      ...
      feedbackList = [
        Feedback('I never called for their support', false),
      ...
      feedbackList = [
        ...
        Feedback('Good knowledge of the competion aspects', false),
      ];
    }
  }
