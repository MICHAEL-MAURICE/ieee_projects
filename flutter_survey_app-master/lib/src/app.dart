...
class SplashScreenState extends State<SplashScreen>
  ...
  List<SecondQuestion> usingCollection = [
    SecondQuestion('daily', 'Each one i love you'),
    SecondQuestion('onceAWeek', 'Every a couple of weeks'),
    SecondQuestion('onceAMonth', 'Once every month'),
    SecondQuestion('everyMoths', 'Every 3 months'),
    SecondQuestion('lessThanYears', 'Maybe 1 or 2 a years'),
  ];
...
//                color: Colors.blue,
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
                ...
                child: Text('Rate your overall event satisfaction? ')),
            Container(
          ...
          child: Opacity(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 16.0),
                    child: Text('How often do you typically enter any of our main events?')),
                Expanded(
                  child: Center(
                    child: Container(
                      height: 258.0,
  ...
  List<ThirdQuestion> thirdQuestionList = [
    ThirdQuestion('Well educated', false),
    ThirdQuestion('The love of helping others', false),
    ThirdQuestion('The spirit of sharing', false),
    ThirdQuestion('Every thing IEEE have to offer', false),
  ];
          ...
          child: Opacity(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 16.0),
                    child: Text('What moustly you like about our event')),
                Expanded(
                  child: Center(
                    child: Container(
                      height: 213.0,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 16.0),
                    child: Text(
                        'whats your concerns related to the organizers and the advisors at the event at total where?')),
                Expanded(
                  child: Center(
                    child: Container(
                      height: 213.0,
            ...
            Opacity(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    'Tell us your opinion so we will perform better next time?.',
                    style: TextStyle(
                        color: Colors.blueAccent,
                        fontWeight: FontWeight.bold,
                        fontSize: 30.0),
                  ...
                  Padding(
                    ...
                    child: Text(
                      'By answering this 3 minutes survey, you help us improve our organization for the event better for you',
                      style: TextStyle(
                        fontSize: 16.0,
                      ),
                    ),
